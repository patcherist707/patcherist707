  ...
  return (
    <section id="contact" className="relative z-10 py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="p-6 rounded-2xl bg-white dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 shadow-lg">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href={`mailto:${resumeData.personal.email}`} className="text-sm font-semibold hover:text-cyan-500 transition-colors">
